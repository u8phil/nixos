  ...
  xdg.configFile."kxmlgui5/dolphin/dolphinui.rc".text = ''
    ...
    <gui name="dolphin" version="46">
     ...
     <ActionProperties scheme="Default">
      ...
      <Action icon="actor" name="act_as_admin" priority="0"/>
